...
public class TestPure2speaker_nikerne {
  ...
  public static void main(String[] args) throws IOException {
    ...
    FileWriter logfile = new FileWriter("TestPure2speaker_nikerne.txt");
    ...
    // FFTs:
    String[] args_48_fft = { "test_data/test_pure/ernest_48_fftmag_1400_train",
        "test_data/test_pure/nikolaus_48_fftmag_1400_train", "test_data/test_pure/ernest_48_fftmag_1400_eval",
        "test_data/test_pure/nikolaus_48_fftmag_1400_eval", };
    EvaluateFeatures fEval_48_fft = createFeatureEvaluator(args_48_fft, 4, 4);


    // logffts
    String[] args_48_logfft = { "test_data/test_pure/ernest_48_logfftmag_1400_train",
        "test_data/test_pure/nikolaus_48_logfftmag_1400_train", "test_data/test_pure/ernest_48_logfftmag_1400_eval",
        "test_data/test_pure/nikolaus_48_logfftmag_1400_eval", };
    ...
    // Raw
    String[] args_16_raw = { "test_data/test_pure/ernest_16_raw_train", "test_data/test_pure/nikolaus_16_raw_train",
        "test_data/test_pure/ernest_16_raw_eval", "test_data/test_pure/nikolaus_16_raw_eval", };
    EvaluateFeatures fEval_16_raw = createFeatureEvaluator(args_16_raw, 3, 3);

    // FFTs
    String[] args_16_fft = { "test_data/test_pure/ernest_16_fftmag_train",
        "test_data/test_pure/nikolaus_16_fftmag_train", "test_data/test_pure/ernest_16_fftmag_eval",
        "test_data/test_pure/nikolaus_16_fftmag_eval", };
    EvaluateFeatures fEval_16_fft = createFeatureEvaluator(args_16_fft, 4, 4);

    // logFFTs
    String[] args_16_logfft = { "test_data/test_pure/ernest_16_logfftmag_train",
        "test_data/test_pure/nikolaus_16_logfftmag_train", "test_data/test_pure/ernest_16_logfftmag_eval",
        "test_data/test_pure/nikolaus_16_logfftmag_eval", };
    EvaluateFeatures fEval_16_logfft = createFeatureEvaluator(args_16_logfft, 4, 4);

    // MFCC hamming window
    String[] args_16_mfcc_hamm = { "test_data/test_pure/ernest_16_melfcc_new_ME0_train",
        "test_data/test_pure/nikolaus_16_melfcc_new_ME0_train", "test_data/test_pure/ernest_16_melfcc_new_ME0_eval",
        "test_data/test_pure/nikolaus_16_melfcc_new_ME0_eval", };
    EvaluateFeatures fEval_16_mfcc_hamm = createFeatureEvaluator(args_16_mfcc_hamm, 16, 16);

    // MFCC rectangular window
    String[] args_16_mfcc_rect = { "test_data/test_pure/ernest_16_melfcc_new_RE0_train",
        "test_data/test_pure/nikolaus_16_melfcc_new_RE0_train", "test_data/test_pure/ernest_16_melfcc_new_RE0_eval",
        "test_data/test_pure/nikolaus_16_melfcc_new_RE0_eval", };
    EvaluateFeatures fEval_16_mfcc_rect = createFeatureEvaluator(args_16_mfcc_rect, 16, 16);
    ...
    logfile.append("Sarsa, epsilon=0.1, gamma=lambda=0.0, roughly 22000 total features, activeFeature\n");
