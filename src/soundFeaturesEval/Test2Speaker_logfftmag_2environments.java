...
public class Test2Speaker_logfftmag_2environments {
  ...
  public static void main(String[] args) throws IOException {
    ...
    FileWriter logfile = new FileWriter(
                                        "test_data/test_recorded/4speaker_feb02_logfftmag_1365/results_logfftmag_1365.txt");
    ...
    String[] gabVSchr_workVSgrem = {
        "test_data/test_recorded/4speaker_feb02_logfftmag_1365/christian_centermic_workstation.txt_48_logfftmag_1365",
        "test_data/test_recorded/4speaker_feb02_logfftmag_1365/gabor_centermic_workstation.txt_48_logfftmag_1365",
        "test_data/test_recorded/4speaker_feb02_logfftmag_1365/christian_centermic_gremlin2.txt_48_logfftmag_1365",
        "test_data/test_recorded/4speaker_feb02_logfftmag_1365/gabor_centermic_gremlin2.txt_48_logfftmag_1365" };
    String[] gabVSchrVSthomasVSmoham_workVSgrem = {
        "test_data/test_recorded/4speaker_feb02_logfftmag_1365/christian_centermic_workstation.txt_48_logfftmag_1365",
        "test_data/test_recorded/4speaker_feb02_logfftmag_1365/gabor_centermic_workstation.txt_48_logfftmag_1365",
        "test_data/test_recorded/4speaker_feb02_logfftmag_1365/thomas_centermic_workstation.txt_48_logfftmag_1365",
        "test_data/test_recorded/4speaker_feb02_logfftmag_1365/mohammed_centermic_workstation.txt_48_logfftmag_1365",
        "test_data/test_recorded/4speaker_feb02_logfftmag_1365/christian_centermic_gremlin2.txt_48_logfftmag_1365",
        "test_data/test_recorded/4speaker_feb02_logfftmag_1365/gabor_centermic_gremlin2.txt_48_logfftmag_1365",
        "test_data/test_recorded/4speaker_feb02_logfftmag_1365/thomas_centermic_gremlin2.txt_48_logfftmag_1365",
        "test_data/test_recorded/4speaker_feb02_logfftmag_1365/mohammed_centermic_gremlin2.txt_48_logfftmag_1365" };
    ...
    logfile.append("Number of Speakers: 2 and 4\n");
    ...
    logfile.append("\nResults (Accuracy):\n");
    logfile
        .append("# of Training steps |  gabVSchr_workVSgrem | gabVSchrVSmohamVSthoma_workVSgrem | gabVSchr_gremVSwork | gabVSchrVSmohamVSthoma_gremVSwork \n\n");
    for (int iteration = 0; iteration < 2; iteration++) {
      for (int n : logarithmicScale) {
        ...
        chosenPersons_4 = CDArrays.randIntArray(n, 0, 4);
        ...
        fEval_gabVSchrVSthomasVSmoham_workVSgrem.train(n, chosenPersons_4, chosenSamples);

        fEval_gabVSchr_gremVSwork.train(n, chosenPersons_2, chosenSamples);
        fEval_gabVSchrVSthomasVSmoham_gremVSwork.train(n, chosenPersons_4, chosenSamples);
