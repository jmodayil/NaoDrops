...
public class createARFF {
  ...
  private static double[][][] readInput(String[] args) {
    ...
    for (int n = 0; n < length; n++) {
      try {
        ...
        realData[n] = ((double[][]) in.readObject());
        in.close();
    ...
    System.out.println("Dimensions of feature Data: " + realData.length + " " + realData[realData.length - 1].length
        + " " + realData[realData.length - 1][realData[realData.length - 1].length - 1].length);
